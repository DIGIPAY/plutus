...
ActiveRecord::Schema.define(version: 20161003073545) do
  ...
  create_table "plutus_balance_logs", force: :cascade do |t|
    t.integer "account_id"
    t.decimal "balance",     precision: 20, scale: 10
    t.integer "month_index"
  end

  add_index "plutus_balance_logs", ["account_id"], name: "index_plutus_balance_logs_on_account_id"
  add_index "plutus_balance_logs", ["month_index"], name: "index_plutus_balance_logs_on_month_index"
